...
def expInfo():
    expInfo={}
    expInfo["appName"] = "struts2"
    expInfo["appVersion"] = "all"
    expInfo["author"] = "coffeehb"
    expInfo["description"] = "check struts2"
    expInfo["references"] = "https://github.com/coffeehb/struts2_check/blob/master/struts2_hunt_v2.py"
